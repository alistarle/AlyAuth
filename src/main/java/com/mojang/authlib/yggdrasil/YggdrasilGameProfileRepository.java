    ...
    public void findProfilesByNames(String[] names, Agent agent, ProfileLookupCallback callback) {
        ...
        for (List<String> request : Iterables.partition(criteria, ENTRIES_PER_PAGE)) {
            ...
            do {
                ...
                try {
                    ProfileSearchResultsResponse response = authenticationService.makeRequest(HttpAuthenticationService.constantURL(SEARCH_PAGE_URL), request, ProfileSearchResultsResponse.class);
                    failCount = 0;
